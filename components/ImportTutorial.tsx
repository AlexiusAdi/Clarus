...
export const ImportTutorial = () => {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div
        className={cn(
          "flex flex-col divide-y divide-border border border-border rounded-xl overflow-hidden transition-all duration-500 ease-in-out",
          open
              ...
              <table className="text-xs w-full">
                <thead>
                  <tr className="bg-emerald-700 text-white">
                    {["date", "amount", "type", "category", "description"].map(
                      (h) => (
                        <th
                          key={h}
              ...
              <table className="text-xs w-full">
                ...
                <tbody>
                  ...
                  <tr className="bg-muted/30">
                    ...
                    <td className="px-2 py-1.5 text-muted-foreground">Food</td>
                    <td className="px-2 py-1.5 text-muted-foreground">
                      Warteg
                    </td>
                  </tr>
